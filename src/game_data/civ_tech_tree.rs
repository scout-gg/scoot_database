...
//             unit: Unit::by_id(conn, self.node_id)?.name,
...
//             age: get_age(self.age_id, conn)?,
//             tech: Tech::by_id(conn, self.node_id)?.name,
//             child: None,
//             picture_index: self.picture_index,
//         })
//     }
...
//             picture_index: self.picture_index,
//             units,
//             building: Building::by_id(conn, self.building_id)?.name,
//             researches,
//         })
//     }
// }
...
//         if self.tech == link_id && self.child.is_none() {
//             true
//         } else {
//             match &self.child {
...
//         "Dark Age".to_string()
//     } else {
//         HelpText::by_id(conn , Tech::by_id(conn, age_id as i32 + 99)?.name)?.content_en
//     })
// }
//
// impl CivTechTreeUnitData {
...
//                 tech: Tech::by_id(conn, upgrade.trigger_tech_id).unwrap().name,
